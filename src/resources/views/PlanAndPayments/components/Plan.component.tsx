            ...
            <div>
              ...
              <div>
                ...
                <ul className="list-disc ml-8 mt-1 text-gray-600">
                  <li><strong>{ item.quantity }</strong> respostas por mês</li>
                  <li><strong>Ilimitados</strong> websites</li>
                  <li><strong>Ilimitadas</strong> enquetes</li>
                  <li><strong>Ilimitado</strong> usuários</li>
                </ul>
              </div>
            </div>
            <div className='w-full'>
              ...
              <div className='text-gray-600 w-full h-full flex flex-col mt-3'>
                <p className='flex items-center gap-2'>
                  ...
                  Respostas <strong>mensal:</strong> { item.responses } de { item.quantity }
                </p>
                <div className="w-[90%] bg-gray-300 h-2">
                  <div className="bg-blue-600 h-2 transition-all duration-300" style={{ width: `${item.percentage}%` }}></div>
                </div>
